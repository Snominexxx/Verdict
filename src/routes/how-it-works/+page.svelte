...
<div class="max-w-5xl mx-auto p-8 sm:p-12 space-y-10">
	<header class="space-y-4 border border-white/15 bg-white/[0.05] rounded-2xl p-8">
		<p class="text-xs uppercase tracking-[0.3em] text-white/60">{t('how.kicker', $language)}</p>
		<h1 class="text-4xl font-display text-white">{t('how.title', $language)}</h1>
	...
	<section class="space-y-4">
		...
		<div class="bg-white/[0.06] p-8 rounded-xl border border-white/15 space-y-6">
